...
const mortgageTypes = [
    {
        ...
        description:
            'A fixed rate stays the same for your entire term, giving you predictable payments. A variable rate fluctuates with the Bank of Canada\u2019s prime rate, so it can save you money when rates drop but costs more when they rise.',
    },
    {
...
const downPaymentTiers = [
    { range: 'Under $500,000', minimum: '5% of purchase price', example: 'e.g. $25,000 on a $500K home' },
    {
        ...
        minimum: '5% on the first $500K + 10% on the remainder',
        example: 'e.g. $50,000 on a $750K home',
    },
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <AnimatedSection>
                        ...
                        <p className="text-brand-text-muted text-lg leading-relaxed font-light max-w-2xl mx-auto mb-10">
                            Everything you need to understand mortgage payments, first-time buyer programs, and the
                            Canadian home financing process, so you can buy with confidence.
                        </p>
                    </AnimatedSection>
                    ...
                    <AnimatedSection>
                        <div className="text-center mb-16">
                            ...
                            <p className="text-brand-text-muted text-lg font-light mt-4 max-w-2xl mx-auto">
                                Canada has some excellent programs to help first-time buyers. Here are the ones you
                                should know about.
                            </p>
                        </div>
                    </AnimatedSection>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <AnimatedSection>
                        ...
                        <p className="text-center text-sm text-brand-text-muted font-light mt-6 max-w-3xl mx-auto">
                            If your down payment is less than 20%, you&apos;ll need CMHC mortgage default insurance,
                            which is added to your mortgage balance. The premium ranges from 2.8% to 4% of the mortgage
                            amount depending on your down payment size.
                        </p>
                    </AnimatedSection>
                </div>
            </section>
                            ...
                            <AnimatedSection key={i}>
                                <details className="group bg-white border border-brand-border rounded-sm">
                                    <summary className="cursor-pointer p-6 flex justify-between items-center font-display text-lg text-brand-text hover:text-brand-accent transition-colors">
                                        {item.term}
                                        <span className="text-brand-accent text-xl group-open:rotate-45 transition-transform duration-200">
                                            +
                                        </span>
                                    </summary>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <AnimatedSection>
                        ...
                        <p className="mt-8 text-brand-text-muted/60 text-xs font-light max-w-2xl mx-auto leading-relaxed">
                            ...
                            standard Canadian mortgage formula with semi-annual compounding. Your actual rate and
                            payment will depend on your lender and financial situation. Always consult directly with a
                            mortgage broker or your bank for a fully accurate qualification.
                        </p>
                    </AnimatedSection>
                </div>
            </section>
